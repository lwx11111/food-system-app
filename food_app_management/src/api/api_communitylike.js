...
export default {
  ...
  downloadExcelTemplate(params) {
    return request({
      url: '/communitylike/downloadExcelTemplate',
      method: 'post',
      data: params,
