...
public class MenuController {
    ...
    public SimpleResponse save(@RequestBody MenuVO obj){
        SimpleResponse response = new SimpleResponse();
        try {
    ...
    @PostMapping("/delby")
    @Operation(description = "条件删除菜谱信息表")
    ...
    @PostMapping("/selby")
    @ResponseBody
    public List<Menu> selectBy(@RequestBody(required = false) Map<String, String> params) {
    ...
    public SimpleResponse selectPage(@RequestBody Map<String, String> params) {
        SimpleResponse response = new SimpleResponse();
        try {
            IPage<MenuVO> page = service.selectPage(params);
            response.setData(page);
        } catch (Exception e) {
            e.printStackTrace();
            response.setCode(500);
    ...
    @ResponseBody
    public IPage<Menu> selpageCustomSqlByWrapper(@RequestBody Map<String, String> params) {
        return service.selpageCustomSqlByWrapper(params);
    }

    @PostMapping("/selpageCustomSqlByMap")
    @Operation(description = "分页查询-自定义sql-Map菜谱信息表")
    @ResponseBody
    public IPage<Menu> selpageCustomSqlByMap(@RequestBody Map<String, String> params) {
