                ...
                <el-collapse-item name="1">
                    ...
                    <div style="display: flex;"
                        ...
                        <el-form :inline="true"
                            ...
                            <el-form-item label="原料JSON">
                                <el-input placeholder="请输入原料JSON"
                                            v-model="data.formList.Ingredients"
                                            style="width: 200px"
                                            @keyup.enter.native="getData">
                                  </el-input>
                            </el-form-item>
                            <el-form-item label="步骤JSON">
                                <el-input placeholder="请输入步骤JSON"
                                            v-model="data.formList.steps"
                                            style="width: 200px"
                                            @keyup.enter.native="getData">
                                  </el-input>
                            </el-form-item>
                            ...
                            <el-form-item label="菜谱首页图片">
                                <el-input placeholder="请输入菜谱首页图片"
                                            v-model="data.formList.image"
                                            style="width: 200px"
                                            @keyup.enter.native="getData">
                                  </el-input>
                            </el-form-item>
                            <el-form-item label="分类 0素菜 1荤菜">
                                <el-input placeholder="请输入分类 0素菜 1荤菜"
