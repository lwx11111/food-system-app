...
public class CommunityLikeController {
    @Autowired
    private ICommunityLikeService service;

    @PostMapping
    @ResponseBody
    @Operation(description = "创建社区帖子点赞表")
    public SimpleResponse save(@RequestBody CommunityLike obj){
    ...
    @PostMapping("/delby")
    @Operation(description = "条件删除社区帖子点赞表")
    ...
    @PostMapping("/selby")
    @ResponseBody
    public List<CommunityLike> selectBy(@RequestBody(required = false) Map<String, String> params) {
        return  service.selectBy(params);
    }

    @PostMapping("/selpage")
    @Operation(description = "分页查询社区帖子点赞表")
    @ResponseBody
    public SimpleResponse selectPage(@RequestBody Map<String, String> params) {
        SimpleResponse response = new SimpleResponse();
        try {
            IPage<CommunityLike> page = service.selectPage(params);
    ...
    @ResponseBody
    public IPage<CommunityLike> selpageCustomSqlByWrapper(@RequestBody Map<String, String> params) {
        return service.selpageCustomSqlByWrapper(params);
    }

    @PostMapping("/selpageCustomSqlByMap")
    @Operation(description = "分页查询-自定义sql-Map社区帖子点赞表")
    @ResponseBody
    public IPage<CommunityLike> selpageCustomSqlByMap(@RequestBody Map<String, String> params) {
