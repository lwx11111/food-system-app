...
public class MessageController {
    ...
    public SimpleResponse save(@RequestBody Message obj){
    ...
    public SimpleResponse update(@PathVariable(name = "id") String id,@RequestBody Message obj){
        SimpleResponse response = new SimpleResponse();
        try {
    ...
    @PostMapping("/selby")
    @ResponseBody
    public List<Message> selectBy(@RequestBody(required = false) Map<String, String> params) {
    ...
    public SimpleResponse selectPage(@RequestBody Map<String, String> params) {
        SimpleResponse response = new SimpleResponse();
        try {
            IPage<Message> page = service.selectPage(params);
    ...
    @ResponseBody
    public IPage<Message> selpageCustomSqlByWrapper(@RequestBody Map<String, String> params) {
    ...
    @ResponseBody
    public IPage<Message> selpageCustomSqlByMap(@RequestBody Map<String, String> params) {
