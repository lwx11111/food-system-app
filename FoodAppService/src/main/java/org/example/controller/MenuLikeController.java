...
public class MenuLikeController {
    ...
    public SimpleResponse update(@PathVariable(name = "id") Integer id,@RequestBody MenuLike obj){
        SimpleResponse response = new SimpleResponse();
        try {
    ...
    @GetMapping("/{id}")
    @Operation(description = "按ID查询用户点赞表")
    @ResponseBody
    ...
    @PostMapping("/dels")
    @ResponseBody
    @Operation(description = "按ID删除多个用户点赞表")
    ...
    @PostMapping("/delby")
    @Operation(description = "条件删除用户点赞表")
    ...
    @PostMapping("/selpage")
    @Operation(description = "分页查询用户点赞表")
    @ResponseBody
