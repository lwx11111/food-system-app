...
public class CommunityController {
    ...
    @PostMapping
    @ResponseBody
    @Operation(description = "创建社区帖子表")
    public SimpleResponse save(@RequestBody Community obj){
    ...
    @PostMapping("/delby")
    @Operation(description = "条件删除社区帖子表")
    ...
    @PostMapping("/selby")
    @ResponseBody
    public List<Community> selectBy(@RequestBody(required = false) Map<String, String> params) {
        return  service.selectBy(params);
    }

    @PostMapping("/selpage")
    @Operation(description = "分页查询社区帖子表")
    @ResponseBody
    ...
    @ResponseBody
    public IPage<Community> selpageCustomSqlByWrapper(@RequestBody Map<String, String> params) {
        return service.selpageCustomSqlByWrapper(params);
    }

    @PostMapping("/selpageCustomSqlByMap")
    @Operation(description = "分页查询-自定义sql-Map社区帖子表")
    @ResponseBody
    public IPage<Community> selpageCustomSqlByMap(@RequestBody Map<String, String> params) {
