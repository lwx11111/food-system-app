...
public interface IDicService extends IService<Dic> {
     ...
     * @return: void
     */
    void saveByParam(Dic obj,Map<String, String> params);
     ...
     * @return: void
     */
    void updateByParam(Dic obj,Map<String, String> params);
    /**
     * 根据条件删除
     *
     * @param params
     ...
     * @return: List<Dic>
     */
     List<Dic> selectBy(Map<String, String> params);
     ...
     * @return: IPage<Dic>
    */
    IPage<Dic> selectPage(Map<String, String> params);
     ...
     * @return: IPage<Dic>
    */
    IPage<Dic> selpageCustomSqlByWrapper(Map<String, String> params);
     ...
     * @return: IPage<Dic>
    */
    IPage<Dic> selpageCustomSqlByMap(Map<String, String> params);
