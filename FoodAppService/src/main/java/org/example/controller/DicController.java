...
public class DicController {
    ...
    public SimpleResponse listFoods(){
        SimpleResponse response = new SimpleResponse();
        try {
            response.setData(service.listFoods());;
        } catch (Exception e) {
    ...
    @ResponseBody
    @Operation(description = "创建")
    public SimpleResponse save(@RequestBody Dic obj){
        SimpleResponse response = new SimpleResponse();
        try {
    ...
    public SimpleResponse update(@PathVariable(name = "id") String id,@RequestBody Dic obj){
        SimpleResponse response = new SimpleResponse();
        try {
    ...
    @PostMapping("/selby")
    @ResponseBody
    public List<Dic> selectBy(@RequestBody(required = false) Map<String, String> params) {
    ...
    public SimpleResponse selectPage(@RequestBody Map<String, String> params) {
        SimpleResponse response = new SimpleResponse();
        try {
            IPage<Dic> page = service.selectPage(params);
    ...
    @ResponseBody
    public IPage<Dic> selpageCustomSqlByWrapper(@RequestBody Map<String, String> params) {
    ...
    @ResponseBody
    public IPage<Dic> selpageCustomSqlByMap(@RequestBody Map<String, String> params) {
